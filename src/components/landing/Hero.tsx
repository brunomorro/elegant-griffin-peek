...
export const Hero = () => {
  return (
    <section className="relative min-h-[90vh] pt-32 pb-20 bg-brand-black overflow-hidden flex items-center">
      {/* Efeitos de brilho de fundo */}
      <div className="absolute top-1/4 -left-20 w-[500px] h-[500px] bg-brand-orange/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 -right-20 w-[400px] h-[400px] bg-brand-orange/5 rounded-full blur-[100px] pointer-events-none" />

      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:grid-cols-12 gap-12 lg:items-center">
          <motion.div 
