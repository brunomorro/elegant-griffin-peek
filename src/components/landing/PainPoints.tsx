        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {pains.map((pain, index) => (
            <motion.div
              ...
              className="p-8 bg-white rounded-3xl border border-black/5 shadow-sm hover:shadow-xl hover:border-brand-orange/20 transition-all group flex flex-col"
            >
              <div className="w-12 h-12 rounded-xl bg-brand-orange/10 flex items-center justify-center mb-6 group-hover:bg-brand-orange transition-colors shrink-0">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-8 bg-brand-black rounded-3xl flex flex-col justify-between group cursor-pointer min-h-[200px]"
          >
